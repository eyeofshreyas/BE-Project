...
from app.controllers.users import delete_user, get_user_delete_impact, list_users, set_client_firm_status, set_user_status, update_own_profile, update_user
...
router.patch("/{user_id}/firm-status", response_model=UserSummary)(set_client_firm_status)
