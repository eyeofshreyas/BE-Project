...
from app.controllers.cases import add_lawyer_to_case, create_case, list_available_case_lawyers, list_cases, remove_lawyer_from_case, update_case_claim_value, update_case_filing_details
...
router.patch("/cases/{case_id}/filing-details", response_model=CaseSummary)(update_case_filing_details)
router.patch("/cases/{case_id}/claim-value", response_model=CaseSummary)(update_case_claim_value)
