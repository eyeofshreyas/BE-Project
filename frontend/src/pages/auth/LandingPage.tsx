...
const SearchIcon = () => <svg {...iconProps}><circle cx={11} cy={11} r={7} /><path d="M21 21l-4.3-4.3" /></svg>
...
const EditIcon = () => <svg {...iconProps}><path d="M12 20h9" /><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4z" /></svg>
...
const CHALLENGES = [
  ...
  { title: 'Hidden Insights', desc: 'Missing critical precedents buried in legacy archives.', icon: <SearchIcon /> },
...
const FEATURES = [
  ...
  { title: 'Precedent Discovery', desc: 'Neural search that understands legal intent across 20+ years of case history.', icon: <SearchIcon /> },
  { title: 'Smart Contracts', desc: 'Automated clause identification and risk scoring for high-stakes negotiations.', icon: <EditIcon /> },
  ...
  { title: 'Drafting AI', desc: "Generative legal writing that adapts to your firm's specific stylistic voice.", icon: <EditIcon /> },
