...
"""Tests for the AI summarize/translate endpoints' case-scoping check on the target document."""
...
def test_summarize_rejects_out_of_scope_document():
    """Verifies summarizing a document whose case is out of scope raises 403 before the ML subprocess runs. Exercises: `POST /ai/summarize` (`summarize.summarize_text()`)."""
