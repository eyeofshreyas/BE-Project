...
const ROLES: { key: RoleKey; title: string; desc: string; icon: (c: string) => React.ReactNode; bullets: string[] }[] = [
  ...
  { key: 'admin', title: 'Organization', desc: "Register your firm and oversee its lawyers, cases and settings.", icon: (c) => <ShieldIcon color={c} />, bullets: ['Lawyer invites & management', 'Reports & analytics', 'Organization settings'] },
]
